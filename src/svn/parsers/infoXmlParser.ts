...
export function parseInfoXml(xml: string, fallbackRoot: string): SvnRepositoryInfo {
  return {
...
function readNestedTag(xml: string, parent: string, tag: string): string | undefined {
