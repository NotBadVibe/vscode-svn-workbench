...
> 产品范围：以 [`完整功能清单与验收矩阵.md`](./完整功能清单与验收矩阵.md) 为准  
> 技术实现与交付：以本文为准  
> 当前实现追踪：[`实现状态与验收追踪.md`](./实现状态与验收追踪.md)  
> 最新候选验收：[`../releases/2026-07-31-v0.0.1.md`](../releases/2026-07-31-v0.0.1.md)
...
> 中文术语、任务化页面、局部滚动、小高度/缩放和真实视口验收的增量门槛见 [`中文用户体验与页面滚动优化及验收方案.md`](./中文用户体验与页面滚动优化及验收方案.md)。发生冲突时，相关体验验收以增量规范为准。
