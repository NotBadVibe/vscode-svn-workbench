...
| 用例 | 覆盖点 |
| --- | --- |
| parses lightweight svn diff summary | 统一 diff 解析为轻量统计摘要。 |
| attaches diff summary to commit message AI request | AI 提交说明请求可携带文件级 diff 摘要。 |
...
AI 提交说明已能使用轻量 diff 摘要。

本轮仍不向模型发送完整代码内容，只发送统计摘要。
