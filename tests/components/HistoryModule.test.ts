...
const snapshot: HistorySnapshot = {
  kind: 'history',
  revisions: [
    { revision: '12', author: 'alice', date: '2026-07-30T08:00:00Z', message: '调整工作台', changedPaths: [{ action: 'M', path: '/trunk/a.ts' }] },
    { revision: '11', author: 'bob', date: '2026-07-29T08:00:00Z', message: '修复范围', changedPaths: [] }
  ],
  selectedRevision: '12',
  compareRevisions: [],
  limit: 100,
...
describe('HistoryModule', () => {
  it('选择两个修订后发送比较请求', async () => {
    ...
    expect(onAction).toHaveBeenCalledWith('history/compare', { revisions: ['12', '11'] });
  });
});
